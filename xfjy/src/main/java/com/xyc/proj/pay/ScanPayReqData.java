...
public class ScanPayReqData {
  ...
  //  private String auth_code = "";
     ...
     */
    public ScanPayReqData(String outTradeNo,int totalFee,String spBillCreateIP,String timeStart,String timeExpire,String openId){
       ...
       // setAuth_code(authCode);
        ...
        setBody(Configure.body);
        
        setAttach(Configure.attach);
